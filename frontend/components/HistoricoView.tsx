  ...
  return (
    <div className="p-4 md:p-8 h-full flex flex-col animate-in fade-in duration-300">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-4 md:gap-0">
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-1">Histórico de Fluxos de Trabalho</h2>
          <p className="text-sm md:text-base text-gray-500">Registro de todas as execuções da rede agêntica, concluídas ou pendentes.</p>
        </div>
      </div>
